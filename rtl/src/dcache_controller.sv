...
module dcache_controller (
   ...
   output wire [31:0] l1d_data_o,
   output wire        l1d_stall_o,
   input  wire [31:0] l1d_data_i,
   input  wire [18:2] l1d_addr_i,
   input  wire [ 3:0] l1d_data_mask_i,
   input  wire        l1d_sel_i,
   ...
   wire [7:0] ADRES = l1d_addr_i[`ADRV];
   
   wire cache_valid_yol0_w = yol0_valid_i;
   wire cache_valid_yol1_w = yol1_valid_i;
   
   wire tag_hit_yol0_w = (l1d_addr_i[`TAGV]==oku_tag_yol0_w) && cache_valid_yol0_w;
   wire tag_hit_yol1_w = (l1d_addr_i[`TAGV]==oku_tag_yol1_w) && cache_valid_yol1_w;
   ...
   assign yol_A0   = (durum_r == RESET) ? counter : l1d_addr_i[`ADRV];
   assign yol_Di0  = {l1d_addr_i[`TAGV], yaz_cache_veri_next_r};
   ...
   assign l1d_data_o = bib_veri_next_r;
   assign l1d_stall_o = (durum_next_r != BOY) || (durum_r != BOY);
   ...
   always@* begin
      ...
      case(durum_r)
         ...
         BOY: begin
            // Yazma (Store) istegi
            if(l1d_sel_i && (|l1d_data_mask_i)) begin
               if(hit_yol0) begin
                  yaz_cache_veri_next_r = l1d_data_i;
                  yaz_en_yol0_next_r = 1'b1;
                  wmask_yaz_next_r = l1d_data_mask_i;
                  yol0_valid_o = 1'b1;
                  yol0_dirty_o = 1'b1;
                  lru_o = 1'b0;
               end
               ...
               if(~hit_yol0 & ~hit_yol1) begin
                  ...
                  if((lru_sec0_w && cache_dirty_yol0_w) || (!lru_sec0_w && cache_dirty_yol1_w)) begin
                     ...
                     iomem_addr_next_r = lru_sec0_w ? {oku_tag_yol0_w,l1d_addr_i[`ADRV]}
                                                         : {oku_tag_yol1_w,l1d_addr_i[`ADRV]};
                  end
                  
                  // LRU olmayan temiz ve word yazilacak
                  if(((lru_sec0_w && !cache_dirty_yol0_w) || (!lru_sec0_w && !cache_dirty_yol1_w)) && (&l1d_data_mask_i)) begin
                     yaz_cache_veri_next_r = l1d_data_i;
         ...
         BELLEK_OKU: begin
            ...
            // Yazma (Store) istegi
               ...
               if(iomem_ready_i && ~(&l1d_data_mask_i)) begin
                  durum_next_r = BOY;
                  // Okunan veriyi cache'e yaz
                  yaz_en_yol0_next_r = lru_sec0_w;
                  yaz_en_yol1_next_r = !lru_sec0_w;
                  wmask_yaz_next_r = 4'b1111;
                  case(l1d_data_mask_i)
                     4'b0001: yaz_cache_veri_next_r = {iomem_rdata_i[31:24],iomem_rdata_i[23:16],iomem_rdata_i[15:8],l1d_data_i   [7:0]};
                     4'b0010: yaz_cache_veri_next_r = {iomem_rdata_i[31:24],iomem_rdata_i[23:16],l1d_data_i   [15:8],iomem_rdata_i[7:0]};
                     4'b0100: yaz_cache_veri_next_r = {iomem_rdata_i[31:24],l1d_data_i   [23:16],iomem_rdata_i[15:8],iomem_rdata_i[7:0]};
                     4'b1000: yaz_cache_veri_next_r = {l1d_data_i   [31:24],iomem_rdata_i[23:16],iomem_rdata_i[15:8],iomem_rdata_i[7:0]};
                     4'b0011: yaz_cache_veri_next_r = {iomem_rdata_i[31:24],iomem_rdata_i[23:16],l1d_data_i   [15:8],l1d_data_i   [7:0]};
                     4'b1100: yaz_cache_veri_next_r = {l1d_data_i   [31:24],l1d_data_i   [23:16],iomem_rdata_i[15:8],iomem_rdata_i[7:0]};
                     default: begin
                     end
                  endcase
                  yol0_valid_o =  lru_sec0_w ? 1'b1 : yol0_valid_i;
