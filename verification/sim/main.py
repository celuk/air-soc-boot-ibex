...
def run_test(simulator: str, test_file: Path, top_module: str, waves: bool, cfile: str):
    ...
    if simulator.lower() == "xcelium":
        ...
        runner_build_args = ["-reflib", "/home/shc/projects/air-soc-boot/vivado/compxip", "-verbose", "-access", "+rwc", "-timescale", "1ns/1ps", "-ALLOWREDEFINITION", "-relax", "-sv"]
        runner_pre_cmd = []
        runner_test_args = ["-reflib", "/home/shc/projects/air-soc-boot/vivado/compxip", "-pre_input", "../pre_input.tcl", "-top", "top.glbl"] #["set probe_packed_limit 131072; set probe_unpacked_limit 131072;"] #["probe -create -packed 131072 *;"]
