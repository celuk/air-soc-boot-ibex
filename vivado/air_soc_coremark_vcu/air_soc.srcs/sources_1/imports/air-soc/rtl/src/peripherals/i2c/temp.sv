...
module temp(
    ...
    // assign scl = scl_r;
    // assign sda = sda_drive? sda_r: 1'bZ;        // Should be Z, but simulation looks bad
    ...
    //                         sample_buf_ns[2] = sda;
    //                         ctr_ns = ctr - 1;
    //                         read_data_ns_r[ctr] = (sample_buf[0]&sample_buf[1]) | (sample_buf[0]&sda) | (sample_buf[1]&sda);
    //                         if(ctr == 0) begin
    ...
    //                         ctr_ns = 7;
    //                         error = `LOW;
    //                         if((sample_buf[0]|sample_buf[1]) & (sample_buf[0]|sda) & (sample_buf[1]|sda)) begin // NOT ACKED ERROR
    //                             state_ns = IDLE;
    //                             error = `HIGH;
    //                         end
    //                     end
